...
class InsertPaymentTab extends StatefulWidget {
  @override
  _InsertPaymentTabState createState() => _InsertPaymentTabState();
}

class _InsertPaymentTabState extends State<InsertPaymentTab> {
                                  ...
                                  return TextField(
                                    onChanged: (value) {
                                      ...
                                      setState(
                                        () {
                                          cardNumber = value;
                                          var valueFormated = detectCCType(
                                              value.replaceAll(" ", ""));
                                          if (value == null ||
                                              value == '' ||
                                              valueFormated ==
                                            ...
                                            asset =
                                                'images/dinnersclub_logo.png';
                                            brand = 'dinersclub';
                                          } else if (valueFormated ==
                                              CreditCardType.amex) {
                                            asset =
                                                'images/americam_express_logo.png';
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: StreamBuilder<Object>(
                                      stream:
                                          _creditCardBloc.outValidateDateCard,
                                      builder: (context, snapshot) {
                                        return TextField(
                                          autocorrect: false,
                                          textCapitalization:
